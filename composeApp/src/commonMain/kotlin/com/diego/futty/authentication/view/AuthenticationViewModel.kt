...
class AuthenticationViewModel: AuthenticationViewContract, ViewModel() {
    ...
    private val _currentRoute = mutableStateOf<AuthenticationRoute>(AuthenticationRoute.Signup) // Luego habrá una logica dependiendo del usuario cual es la pantalla inicial
